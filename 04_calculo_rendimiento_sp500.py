...
if __name__ == '__main__':
	...
	for row in valores:
		...
		if valor == "US500":
			...
			sp500 = [tipo, valor, rendimientos[0], rendimientos[1], rendimientos[2], rendimientos[3], rendimientos[4], rendimientos[5]]
	...
	for row in valores:
		...
		if valor in PROCESAR or PROCESAR[0] == "ALL":	
			...
			rendimientos[0] -=  sp500[2]
			rendimientos[1] -=  sp500[3]
			rendimientos[2] -=  sp500[4]
			rendimientos[3] -=  sp500[5]
			rendimientos[4] -=  sp500[6]
			rendimientos[5] -=  sp500[7]
	...
	filename = os.path.join(os.path.dirname(__file__), 'result', 'RENDIMIENTO_SP500_' + ahora + '.csv')
